...
## Models of Movement {auto-animate=true}
...
## Simulation Results {auto-animate=true}
...
We can also plot the empirical cumulative distribution of hitting times between pairs of hospitals across $N=20$ realisations
